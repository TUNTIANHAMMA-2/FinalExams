...
本仓库整理了几门期末作业的最终交付物和答辩辅助材料。目录中的子项目类型不同：有软件工程设计报告、基于 RhizoDelta 的课程报告，也有可运行的 Python 项目。根目录 README 作为统一入口，方便快速找到正式报告、答辩稿、运行说明和辅助文档。
...
| 目录 | 课程 / 主题 | 类型 | 主要入口 |
| --- | --- | --- | --- |
| [SoftwareEngineering](./SoftwareEngineering/) | 软件工程导论：宿舍报修管理系统 | 报告型软件工程设计作业 | [项目 README](./SoftwareEngineering/README.md) / [答辩稿](./SoftwareEngineering/答辩.md) / [辅助文档](./SoftwareEngineering/docs/README.md) |
| [vuejs-app-dev](./vuejs-app-dev/) | Vue.js 应用开发：RhizoDelta 前端方向报告 | 基于 RhizoDelta 的前端课程报告 | [项目 README](./vuejs-app-dev/README.md) / [答辩稿](./vuejs-app-dev/答辩.md) / [辅助文档](./vuejs-app-dev/docs/README.md) |
| [javaee-web-app](./javaee-web-app/) | JavaEE 企业级 Web 应用开发实战：RhizoDelta 后端方向报告 | 基于 RhizoDelta 的后端课程报告 | [项目 README](./javaee-web-app/README.md) / [答辩稿](./javaee-web-app/答辩.md) / [辅助文档](./javaee-web-app/docs/README.md) |
...
每个子项目都保留顶层 `README.md` 和 `答辩.md`，用于快速确认交付物和准备口头说明；同时在 `docs/` 下补充统一的辅助文档：
...
- 人工智能课程项目：进入 [python-ai-course](./python-ai-course/) 并按该目录下的 README 安装依赖、启动后端和前端。
- Python 数据收集与分析项目：进入 [python-data-collection-analysis](./python-data-collection-analysis/) 并按该目录下的 README 运行数据分析脚本。
...
- 对报告型项目，`generated/`、`images/` 多为报告生成素材或中间产物；对 `python-data-collection-analysis/`，`generated/` 中的统计表、图表和 PDF 预览属于可复核结果。
- 运行时数据、模型文件、虚拟环境和本地工具目录不作为核心提交材料。
