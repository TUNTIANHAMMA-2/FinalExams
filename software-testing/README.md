...
| 交付物 | 文件 | 状态 |
| --- | --- | --- |
| 考查报告封面 | [《软件测试技术》考查报告.docx](./《软件测试技术》考查报告.docx) / [《软件测试技术》考查报告.doc](./《软件测试技术》考查报告.doc) | ✅ 已按模板副本填写（身份字段保留请填写） |
| 1 测试方案 | [deliverables/1-测试方案.docx](./deliverables/1-测试方案.docx) / [deliverables/1-测试方案.doc](./deliverables/1-测试方案.doc) | ✅ 已按 `1测试方案.doc` 模板副本填写 |
| 2 测试用例 | [deliverables/2-测试用例.xlsx](./deliverables/2-测试用例.xlsx) / [deliverables/2-测试用例.xls](./deliverables/2-测试用例.xls) | ✅ 已按 `2测试用例.xls` 模板副本填写，20 条实测用例 |
| 3 Bug 缺陷报告清单 | [deliverables/3-Bug缺陷报告清单.xlsx](./deliverables/3-Bug缺陷报告清单.xlsx) / [deliverables/3-Bug缺陷报告清单.xls](./deliverables/3-Bug缺陷报告清单.xls) | ✅ 已按 `3Bug缺陷报告清单.xls` 模板副本填写，2 个实测缺陷 |
| 4 接口测试（Postman） | [deliverables/4-接口测试-Postman.md](./deliverables/4-接口测试-Postman.md) | ✅ 20 用例已跑 + newman 报告 |
| 5 测试总结报告 | [deliverables/5-测试总结报告.docx](./deliverables/5-测试总结报告.docx) / [deliverables/5-测试总结报告.doc](./deliverables/5-测试总结报告.doc) | ✅ 已按 `5测试总结报告.doc` 模板副本填写 |

## 阅读顺序

1. [《软件测试技术》考查报告.docx](./《软件测试技术》考查报告.docx)（封面、截图与个人总结）
...
5. `deliverables/` 下五份交付物（优先使用 `.doc/.docx/.xls/.xlsx` 模板副本版）
